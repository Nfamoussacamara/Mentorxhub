...
(function() {
    ...
    if (sidebarResizer && sidebar && dashboardMain) {
        ...
        document.addEventListener('mousemove', function(e) {
            ...
            // Limiter la largeur entre 70px et 400px
            ...
            if (newWidth < 150) {
                // Réduire progressivement l'opacité entre 150px et 70px
                const opacity = (newWidth - 70) / 80; // 0 à 1
                ...
                // Afficher complètement au-delà de 150px
                labels.forEach(label => {
    ...
    if (sidebar) {
        ...
        // Restaurer la largeur personnalisée
    ...
    // Fonction pour préserver la largeur de la sidebar
    function preserveSidebarState() {
        ...
        // Restaurer la largeur si elle existe et que la sidebar n'est pas collapsed
        if (savedWidth && !isCollapsed && !sidebar.classList.contains('collapsed')) {
            const width = parseInt(savedWidth);
            if (sidebar.style.width !== width + 'px') {
                sidebar.style.width = width + 'px';
                if (dashboardMain) {
                    dashboardMain.style.marginLeft = width + 'px';
                }
    ...
    // Préserver l'état après chaque changement de page
    ...
    function handleResize() {
        if (window.innerWidth > 1024 && sidebar) {
            sidebar.classList.remove('open');
            // Restaurer la largeur personnalisée sur desktop
