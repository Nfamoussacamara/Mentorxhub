/**
 * MentorXHub - JavaScript pour les pages d'authentification
 * Login et Signup
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============================================
    // ANIMATION DES PHRASES D'ACCROCHE (LOGIN)
    // ============================================
    const taglines = [
    ...
    // ============================================
    // GESTION DU FORMULAIRE DE SIGNUP
    // ============================================
    const signupForm = document.querySelector('form[method="post"]');
    const password1Input = document.getElementById('password1');
    const password2Input = document.getElementById('password2');

    // Fonction pour basculer la visibilité du mot de passe (SIGNUP)
    window.togglePass = window.togglePass || function(fieldId) {
    ...
    // Validation du formulaire signup côté client
    if (signupForm && password1Input && password2Input) {
